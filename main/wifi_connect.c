...
/* Project:     Green House		                                     	      */
/*                                                                            */
/* FileName:    wifi_connect.c                                                */
/*                                                                            */
/* Author:      Michael Bester                                                */
/*                                                                            */
/* Overview:    This module contains the functions releated to the wifi       */
/*              connection.                                                   */
/*                                                                            */
/* Notes:                                                                     */
/*                                                                            */
                      ...
                      int32_t event_id, void *event_data)
{
    ...
    gpio_set_level(STATUS_LED_PIN, 0);						  /* Turn on LED. */
}
                               ...
                               int32_t event_id, void *event_data)
{
    ...
    gpio_set_level(STATUS_LED_PIN, 0);						 /* Turn off LED. */
